(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      .brgy-msg-top{height:6px; background:var(--brgy-msg-color,#2563eb);}
      ...
      .brgy-msg-icon{
        ...
        background:color-mix(in srgb, var(--brgy-msg-color,#2563eb) 12%, white); color:var(--brgy-msg-color,#2563eb);
      ...
      .brgy-msg-input:focus{border-color:var(--brgy-msg-color,#2563eb); box-shadow:0 0 0 3px color-mix(in srgb, var(--brgy-msg-color,#2563eb) 17%, white);}
      ...
      .brgy-msg-btn-primary{background:var(--brgy-msg-color,#2563eb); color:#fff; box-shadow:0 10px 22px color-mix(in srgb, var(--brgy-msg-color,#2563eb) 28%, transparent);}
